    ...
    */
    ...
    module: {
      ...
      rules: [
         ...
         * Executes first css-loader, then to-string-loader and returns file content as string.
         */
        {
          test: /\.css$/,
        ...
        /*
        * to string and css and sass converter for *.scss files.
        * Executes first sass-loader, then css-loader, then to-string-loader and returns file content as string.
        */
        {
          test: /\.scss$/,
